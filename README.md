...
```
https://raw.githubusercontent.com/rwinox/oh/refs/heads/main/configs/proxy_configs.txt
```
...
```
https://raw.githubusercontent.com/rwinox/oh/refs/heads/main/configs/singbox_configs.json
```
...
### Detailed Report
📊 [View Full Interactive Dashboard](https://htmlpreview.github.io/?https://github.com/rwinox/oh/blob/main/assets/performance_report.html)
...
2. Locate the following line:
   ```markdown
   📊 [View Full Interactive Dashboard](https://htmlpreview.github.io/?https://github.com/USERNAME/oh/blob/main/assets/performance_report.html)
   ```
...
git clone https://github.com/rwinox/oh.git
